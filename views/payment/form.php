<?php
// PHP logic to handle prefilling from URL if needed
$amount_from_url = isset($_GET['amount']) ? $_GET['amount'] : null;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <!-- <meta property="og:image" content="<?php echo url('thumb.jpg'); ?>"> -->
    ...
    <!-- <meta name="twitter:image" content="<?php echo url('thumb.jpg'); ?>"> -->
    ...
    <div class="container">
        <div class="header">
            <div class="header-logo">
                <img src="<?php echo url('logo.png'); ?>" alt="DigiMart Solutions">
            </div>
        ...
        <div class="card">
            ...
            <form id="paymentForm" class="form-container" method="POST" action="<?php echo url('pay/process'); ?>">
                <div class="info-box">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="full_name" name="full_name" placeholder="John Doe" required autocomplete="name" value="<?php echo isset($_POST['full_name']) ? htmlspecialchars($_POST['full_name']) : ''; ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" placeholder="john@example.com" required autocomplete="email" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-currency">
                        ...
                        <input type="number" id="amount" name="amount" placeholder="1,000.00" step="0.01" min="1" value="<?php echo isset($_POST['amount']) ? htmlspecialchars($_POST['amount']) : ($amount_from_url ? number_format((float)$amount_from_url, 2, '.', '') : ''); ?>" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="note" name="note" placeholder="Enter payment reference or additional notes..."><?php echo isset($_POST['note']) ? htmlspecialchars($_POST['note']) : ''; ?></textarea>
                </div>
